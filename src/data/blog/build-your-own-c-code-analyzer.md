...
In an article I wrote years ago, I joked that [async/await is evil](/posts/how-do-you-build-a-fast-lightweight-solution-for-cqrs-and-event-sourcing/), and I am no less inclined to joke about it now. For those of us slinging serious code at serious problems, [asynchronous programming](https://learn.microsoft.com/en-us/dotnet/csharp/asynchronous-programming/async-scenarios) is a textbook example of a necessary evil.
